...
export const catalogServices: CatalogService[] = [
  ...
  },
  {
    id: "outbound-fte",
    name: "Исходящая на выделенных специалистах",
    description: "Обзвон силами закреплённой команды с оплатой по часам — специалисты погружены в ваш продукт и скрипт.",
    category: "исход",
    price: "от 160 000 ₽/мес (пакет 168 чел-ч)",
    features: [
      "Закреплённые операторы под ваш проект",
      "Оплата по часам — пакет чел-часов в месяц",
      "Глубокое погружение в продукт и сценарий",
      "Отчёт: загрузка, звонки/час, целевые за смену",
    ],
    badges: [],
  },
  {
...
export const alerts: AlertItem[] = [
  ...
  {
    id: "a-0",
    text: "Менеджер подобрал для вас новую услугу — смотрите в разделе «Рекомендуем вам»",
    tone: "info",
...
export const calls: Call[] = [
  ...
  },
  {
    ...
    topic: "—",
    ai: {
      summary: "Абонент не дождался соединения с оператором, бросил трубку до ответа. Диалога не было.",
      category: "Без диалога",
      subcategory: "Пропущенный звонок",
      scriptMatch: 0.00,
      triggers: [
        { label: "Звонок пропущен — диалог не состоялся", tone: "warn" },
        { label: "Передан в очередь обратной связи (правило перезвона)", tone: "info" },
      ],
    },
  },
  {
  ...
  },
  {
    ...
    transcript: SAMPLE_TRANSCRIPT_1,
    ai: {
      clientName: "Михайлов Илья",
      summary: "Абонент уточнил статус заказа №3091. Оператор подтвердил передачу в доставку, ориентировочное прибытие — завтра до 14:00.",
      category: "Заказы и доставка",
      subcategory: "Статус заказа",
      scriptMatch: 93.00,
      triggers: [
        { label: "Клиент идентифицирован по номеру заказа", tone: "ok" },
        { label: "Сроки доставки названы корректно", tone: "ok" },
      ],
    },
  },
  {
    ...
    topic: "Перезвон",
    ai: {
      clientName: "Сергеев Максим Юрьевич, ООО «Эталон-Юг»",
      summary: "Согласован перезвон с персональным менеджером по вопросу изменения спецификации договора.",
      category: "Перезвон",
      subcategory: "Согласован",
      scriptMatch: 90.00,
      triggers: [
        { label: "Согласовано время обратного звонка", tone: "ok" },
        { label: "Уровень сервиса по обратной связи соблюдён", tone: "info" },
      ],
    },
  },
  {
    ...
    ai: {
      ...
      summary: "Клиент оформил возврат товара (причина — не подошла модель). Возврат средств на карту в течение 5–10 рабочих дней.",
      category: "Возвраты",
      subcategory: "Не подошло",
      scriptMatch: 83.00,
      triggers: [
        { label: "Соблюдены условия 14-дневного возврата", tone: "ok" },
        { label: "Озвучены корректные сроки возврата средств", tone: "ok" },
      ],
    },
  },
  {
  ...
  // ────────── СЕГОДНЯ (04.06.2026) ──────────
  {
    ...
    transcript: SAMPLE_TRANSCRIPT_1,
    ai: {
      clientName: "Захарова Екатерина",
      summary: "Абонент уточнил статус заказа №4313. Оператор подтвердил передачу в доставку, ориентировочное прибытие — завтра до 14:00.",
      category: "Заказы и доставка",
      subcategory: "Статус заказа",
      scriptMatch: 91.00,
      triggers: [
  ...
  },
  {
    ...
    ai: {
      ...
      summary: "Клиент оформил возврат товара (причина — передумал). Возврат средств на карту в течение 5–10 рабочих дней.",
      category: "Возвраты",
      subcategory: "Не подошло",
      scriptMatch: 87.00,
      triggers: [
  ...
  },
  {
    ...
    ai: {
      clientName: "Сергеев Максим Юрьевич, ООО «Эталон-Юг»",
      summary: "Корпоративный клиент запросил счёт на 240 000 ₽ по спецификации к договору. Оператор подтвердил выставление до конца рабочего дня.",
      category: "Корпоративные операции",
      subcategory: "Счёт по договору",
      scriptMatch: 89.00,
      triggers: [
        { label: "Клиент идентифицирован по договору и ИНН", tone: "ok" },
        { label: "Срок выставления счёта зафиксирован письменно", tone: "ok" },
      ],
    },
  },
  {
    ...
    topic: "Условия доставки",
    ai: {
      summary: "Уточнение по условиям доставки в регион. Стандартный срок 3–5 рабочих дней, стоимость рассчитывается в корзине. Озвучен бесплатный порог от 5 000 ₽.",
      category: "Заказы и доставка",
      subcategory: "Сроки и стоимость",
      scriptMatch: 94.00,
      triggers: [
        { label: "Озвучены тарифы доставки по регионам", tone: "ok" },
        { label: "Предложен бесплатный порог — стимул допродажи", tone: "info" },
      ],
    },
  },
  {
  ...
  },
  {
    ...
    transcript: SAMPLE_TRANSCRIPT_1,
    ai: {
      clientName: "Соколов Артём",
      summary: "Клиент уточнил способы оплаты для юридического лица. Оператор передал заявку на выставление счёта в бухгалтерию.",
      category: "Оплата",
      subcategory: "Счёт для юр. лица",
      scriptMatch: 91.00,
      triggers: [
        { label: "Заявка на счёт зафиксирована", tone: "ok" },
        { label: "Срок выставления озвучен (до конца рабочего дня)", tone: "info" },
      ],
    },
  },
  ...
  // ────────── ВЧЕРА (03.06.2026) ──────────
  {
    ...
    topic: "Статус заказа",
    ai: {
      clientName: "Орлова Светлана",
      summary: "Абонент уточнил статус заказа №4430. Оператор подтвердил передачу в доставку, ориентировочное прибытие — послезавтра в первой половине дня.",
      category: "Заказы и доставка",
      subcategory: "Статус заказа",
      scriptMatch: 88.00,
      triggers: [
  ...
  },
  {
    ...
    ai: {
      clientName: "Сергеев Максим Юрьевич, ООО «Эталон-Юг»",
      summary: "Запрос дубликата сертификата подлинности по изделию из спецификации. Оператор принял заявление, срок — 5 рабочих дней.",
      category: "Технические вопросы",
      subcategory: "Сертификат подлинности",
      scriptMatch: 87.00,
      triggers: [
        { label: "Заявление зафиксировано в системе", tone: "ok" },
        { label: "Срок исполнения соответствует регламенту", tone: "info" },
      ],
    },
  },
  {
  ...
  },
  {
    ...
    ai: {
      summary: "Клиент обсуждал перенос сроков поставки по текущей спецификации. Запрос передан персональному менеджеру для согласования допсоглашения.",
      category: "Договорная работа",
      subcategory: "Изменение условий",
      scriptMatch: 74.00,
      triggers: [
        { label: "Эскалация на персонального менеджера выполнена", tone: "ok" },
        { label: "Озвучено требование о письменном допсоглашении", tone: "warn" },
      ],
    },
  },
  ...
  // ────────── ЭТА НЕДЕЛЯ (28–31.05.2026) ──────────
  {
    ...
    ai: {
      clientName: "Соколов Артём",
      summary: "Абонент уточнил статус заказа №4560. Оператор подтвердил передачу в доставку, ориентировочное прибытие — послезавтра в первой половине дня.",
      category: "Заказы и доставка",
      subcategory: "Статус заказа",
      scriptMatch: 86.00,
      triggers: [
        { label: "Клиент идентифицирован по номеру заказа", tone: "ok" },
        { label: "Сроки доставки названы корректно", tone: "ok" },
        { label: "Предложен трек-номер для самостоятельного отслеживания", tone: "info" },
      ],
    },
  },
  {
    ...
    ai: {
      ...
      summary: "Подбор запчасти по VIN. Оператор подтвердил совместимость через каталог, передал артикул клиенту в SMS.",
      category: "Технические вопросы",
      subcategory: "Подбор по VIN",
      scriptMatch: 87.00,
      triggers: [
        { label: "VIN использован для подбора — снижает риск возврата", tone: "ok" },
        { label: "Артикул отправлен SMS — клиент сможет уточнить позже", tone: "info" },
      ],
    },
  },
  {
  ...
  // ────────── ЭТОТ МЕСЯЦ (08–20.05.2026) ──────────
  {
    ...
    transcript: SAMPLE_TRANSCRIPT_2,
    ai: {
      summary: "Клиент оформил возврат товара (причина — брак упаковки). Возврат средств на карту в течение 5–10 рабочих дней.",
      category: "Возвраты",
      subcategory: "Брак / дефект",
      scriptMatch: 78.00,
      triggers: [
        { label: "Соблюдены условия 14-дневного возврата", tone: "ok" },
        { label: "Озвучены корректные сроки возврата средств", tone: "ok" },
        { label: "Передано в отдел качества для проверки партии", tone: "warn" },
      ],
    },
  },
  {
    ...
    topic: "Перезвон",
    ai: {
      summary: "Согласован перезвон на следующий рабочий день — клиент уточнял условия гарантии. Оператор обещал уточнить срок и перезвонить.",
      category: "Перезвон",
      subcategory: "Согласован",
      scriptMatch: 83.00,
      triggers: [
  ...
  },
  {
    ...
    topic: "Корпоративный счёт",
    ai: {
      clientName: "Тарасова Марина Сергеевна, ООО «АРТ-Декор»",
      summary: "Корпоративный клиент запросил счёт на 125 000 ₽ по спецификации к договору. Оператор подтвердил выставление до конца рабочего дня.",
      category: "Корпоративные операции",
      subcategory: "Счёт по договору",
      scriptMatch: 84.00,
      triggers: [
...
export const serviceScripts: Record<string, ServiceScript> = {
  ...
  // ── НЕЙРОАССИСТЕНТ — это не «скрипт», а БАЗА ЗНАНИЙ ──
  // У бота нет жёсткой последовательности — он выбирает блок по теме обращения.
  // Поэтому те же expandable-блоки звучат не как реплики, а как темы корпуса знаний.
  "chatbot": {
    serviceName: "Нейроассистент на входящую линию",
    version: "4.1",
    updatedAt: "01.06.2026",
    approvedBy: "Согласовано клиентом + методологом O'LINE",
    context:
      "База знаний нейроассистента. Используется ботом для ответов в Telegram, WhatsApp, чате на сайте и голосовой линии. Покрывает 60-70% типовых обращений, остальное эскалируется на оператора.",
    blocks: [
      {
        kind: "header",
        lineNumber: "AI · multi-channel",
        greeting: "Здравствуйте! Я нейроассистент бренда. Чем могу помочь?",
        intro:
          "Я отвечаю в **Telegram, WhatsApp, чате на сайте и по телефону**. Работаю круглосуточно. Если вопрос мне не по силам — мгновенно переключу вас на живого оператора.",
        hint:
          "База знаний обновляется каждые 2 недели. Если бот неуверенно отвечает на новый тип запросов — добавьте тему через менеджера, она появится в боте за 1–2 дня.",
        topics: [
          { left: "Статус заказа", right: "Возврат и обмен" },
          { left: "Условия доставки", right: "Способы оплаты" },
          { left: "Подбор товара", right: "Бонусы и сертификаты" },
          { left: "Жалобы и предложения", right: "Эскалация на оператора" },
        ],
      },
      {
        kind: "expandable",
        ...
        title: "Статус заказа",
        content:
          "**Триггеры:** «где мой заказ», «трек», «когда привезут», номер заказа в сообщении.\n\nЧто отвечает бот:\n1. Просит номер заказа (если ещё не указан).\n2. Тянет статус из CRM по API.\n3. Озвучивает текущее состояние + трек-номер + срок доставки.\n4. Если заказ задержан более чем на 2 дня — сразу предлагает перевод на оператора.\n\nНе обещает конкретный час — только день.",
      },
      {
        kind: "expandable",
        tone: "green",
        ...
        content:
          "**Триггеры:** «сколько стоит доставка», «когда привезёте в <город>», «есть ли самовывоз».\n\nБот отвечает:\n• Срок 3–5 рабочих дней по РФ, 1–2 по МСК/СПб.\n• Стоимость рассчитывается в корзине автоматически.\n• Бесплатно при заказе от **5 000 ₽**.\n• Самовывоз — список ПВЗ выдаёт по запросу города.\n\nЕсли клиент уточняет редкий регион — может предложить открыть калькулятор на сайте.",
      },
      {
        kind: "expandable",
        tone: "blue",
        ...
        content:
          "**Триггеры:** «как оплатить», «принимаете ли карты», «оплата при получении».\n\nБот перечисляет:\n• Карта (Visa, Mastercard, МИР)\n• СБП по QR\n• Наложенный платёж (только для регионов)\n• Юр.лицам — счёт на оплату (направляет в форму заявки)\n\nПри запросе «можно ли в рассрочку» — отвечает «да, через Долями / Сплит» с пояснением.",
      },
      {
        kind: "expandable",
        tone: "blue",
        title: "Подбор товара / VIN",
        content:
          "**Триггеры:** «какая запчасть подойдёт», «подбор по VIN», название модели авто.\n\nЕсли клиент указал VIN — бот делает запрос в каталог по API и предлагает 2–3 подходящих артикула с ценой.\n\nЕсли VIN не указан — просит ввести 17 символов из ПТС или с лобового стекла. Объясняет, зачем нужен VIN (минимизация возвратов).",
      },
      {
        kind: "callout",
        tone: "warn",
        text:
          "**Важно:** бот **не оформляет заказ** самостоятельно. Он может посчитать стоимость и предложить положить в корзину, но финальное оформление — на сайте или с оператором. Это снижает риск ошибок и спорных списаний.",
      },
      {
        kind: "expandable",
        tone: "red",
        title: "Возврат и обмен",
        content:
          "**Триггеры:** «хочу вернуть», «не подошло», «как обменять».\n\nБот:\n1. Спрашивает причину (размер / модель / брак / передумал).\n2. Озвучивает условия — 14 дней с момента получения, сохранение товарного вида.\n3. Для брака — просит фото/видео, прикладывает к заявке.\n4. Создаёт заявку на возврат в системе и присылает номер.\n5. Озвучивает сроки возврата средств (карта 5–10 дн, СБП 1–3 дн).\n\nДля **крупногабарита** (>15 кг) — сразу эскалирует на оператора (нужен расчёт логистики).",
      },
      {
        kind: "expandable",
        tone: "red",
        title: "Жалобы и негатив",
        content:
          "**Триггеры:** мат, восклицательные знаки caps lock, слова «верните деньги», «отвратительно», «жалоба».\n\nБот:\n1. **Не вступает в спор.** Подтверждает, что слышит клиента: «Я понимаю, что ситуация неприятная».\n2. Просит коротко описать суть проблемы (одно сообщение).\n3. **Сразу эскалирует** на оператора — независимо от того, может ли формально ответить сам.\n\nЦель — не «обработать жалобу ботом», а как можно быстрее вывести клиента к человеку.",
      },
      {
        kind: "expandable",
        tone: "blue",
        title: "Бонусы, сертификаты, промокоды",
        content:
          "**Триггеры:** «есть ли скидка», «промокод», «бонусы», «сертификат на день рождения».\n\nБот:\n• Озвучивает программу лояльности (1% кэшбэка, списать до 30%).\n• Подсказывает текущие действующие акции (тянет из CMS).\n• Объясняет, как применить промокод/сертификат в корзине.\n• На запрос «дайте скидку» — вежливо отказывает: «Скидки фиксируются акциями, но накопленные бонусы я могу применить — у вас на счету N бонусов».",
      },
      {
        kind: "expandable",
        tone: "orange",
        title: "Триггеры эскалации на оператора",
        content:
          "Бот **автоматически передаёт диалог человеку**, если:\n\n• Клиент явно просит оператора («дайте человека», «соедините с менеджером»).\n• Третья подряд реплика бота не закрыла вопрос (loop-detection).\n• Тема не покрыта базой знаний (низкий confidence по интенту).\n• Жалоба / негатив / эмоциональный тон.\n• Сумма спорного вопроса > 50 000 ₽.\n• Запрос юр.лица на спецусловия / счёт > 100 000 ₽.\n\nПри эскалации бот пишет: «Подключаю оператора, ожидайте 1–2 минуты» — клиент видит, что разговор не оборвался.",
      },
      {
        kind: "expandable",
        tone: "orange",
        title: "Как бот распознаёт «дозвон по делу» vs. спам",
        content:
          "**Триггеры спама:** «выгодное предложение», «инвестиции», «казино», ссылки на сторонние домены, очень короткие нерелевантные сообщения вне рабочих тем.\n\nБот:\n• Не вступает в диалог.\n• Помечает диалог тегом «возможный спам».\n• Завершает: «Я отвечаю только по вопросам нашего магазина. Если вас интересует наш ассортимент — задайте вопрос».\n\nЕсли клиент уточнит реальную потребность — бот возобновит обычный режим.",
      },
      {
        kind: "expandable",
        tone: "green",
        title: "Прощание и фиксация фидбека",
        content:
          "После решения вопроса бот:\n1. Подтверждает: «Я правильно понял, что вопрос решён?»\n2. Просит оценку: «Оцените, пожалуйста, диалог от 1 до 5».\n3. Прощается: «Спасибо, что обратились! Хорошего дня».\n\nОценки **≤ 3** автоматически попадают в очередь разбора у методолога — это сигнал, что ответ был некорректным или сухим.",
      },
    ],
  },
};
...
export type OutboundCall = {
  id: string;
  serviceId: string;
  uid: string;              // UID звонка из телефонии — для deep-link
  date: string;
  time: string;
  operator: { id: string; name: string };
  ...
  ai?: {
    companyName?: string;   // название компании — основной субъект исходящих B2B
    clientName?: string;    // ФИО собеседника, если ИИ извлёк
    summary: string;
    category: string;       // итог звонка по бизнес-классификации
    subcategory: string;    // конкретный исход / возражение
    scriptMatch: number;    // % соответствия скрипту (см. ScriptMatchBar)
  };
  transcript?: { speaker: "agent" | "client"; text: string; time: string }[];
};
...
export const outboundCalls: OutboundCall[] = [
  ...
  { id: "oc-101", serviceId: "outbound-q2", uid: "1780553709.221383741", date: "04.06.2026", time: "09:15:08", operator: { id: "O0451", name: "Иванова Анна" },     contactNumber: "+7 (916) 311-44-58", segment: "Тёплая база",        attempt: 1, status: "target",      durationSec: 187, topic: "Согласие на встречу",
    ai: {
      companyName: "ООО «Премиум-Сеть»",
      clientName: "Орлова Светлана",
      summary: "Клиент согласился на встречу с менеджером для презентации продукта. Время согласовано, приглашение в календарь отправлено сразу после звонка.",
      category: "Целевое действие",
      subcategory: "Согласие на встречу",
      scriptMatch: 95.00,
    }
  },
  { id: "oc-102", serviceId: "outbound-q2", uid: "1780555704.221397482", date: "04.06.2026", time: "09:48:22", operator: { id: "O0608", name: "Петров Борис" },     contactNumber: "+7 (905) 822-19-30", segment: "Холодная база",      attempt: 1, status: "not_reached", durationSec: 8,
    ai: {
      companyName: "ООО «Альфа-Логистик»",
      summary: "Абонент не взял трубку — после 5 гудков сорвался автодозвон.",
      category: "Без диалога",
      subcategory: "Нет ответа",
      scriptMatch: 0.00,
    }
  },
  { id: "oc-103", serviceId: "outbound-q2", uid: "1780557737.221411123", date: "04.06.2026", time: "10:22:14", operator: { id: "O0729", name: "Сидорова Наталья" }, contactNumber: "+7 (964) 200-33-77", segment: "Возвраты к покупке", attempt: 2, status: "target",      durationSec: 165, topic: "Заказ оформлен",
    ai: {
      companyName: "АО «Старт-Маркет»",
      clientName: "Васильева Ольга Николаевна",
      summary: "Клиент оформил заказ по итогам разговора. Контактные данные подтверждены, оператор передал заказ в обработку.",
      category: "Целевое действие",
      subcategory: "Оформление заказа",
      scriptMatch: 93.00,
    }
  },
  { id: "oc-104", serviceId: "outbound-q2", uid: "1780560346.221424864", date: "04.06.2026", time: "11:05:42", operator: { id: "O0834", name: "Соколов Виктор" },   contactNumber: "+7 (903) 412-66-21", segment: "Тёплая база",        attempt: 1, status: "reached",     durationSec: 92,  topic: "Возражение «дорого»", outcomeReason: "expensive",
    ai: {
      ...
      clientName: "Новиков Андрей",
      summary: "Клиент сослался на стоимость. Оператор корректно отработал возражение, перевёл разговор на бесплатный аудит, но решение клиент принять не готов. Договорились о повторном звонке через 2 недели.",
      category: "Дозвон без целевого",
      subcategory: "Возражение «дорого»",
      scriptMatch: 80.00,
    }
  },
  { id: "oc-105", serviceId: "outbound-q2", uid: "1780564718.221438505", date: "04.06.2026", time: "12:18:33", operator: { id: "O0451", name: "Иванова Анна" },     contactNumber: "+7 (915) 800-11-44", segment: "NPS-опрос",          attempt: 1, status: "target",      durationSec: 134, topic: "Оценка 9/10",
    ai: {
      companyName: "ООО «Эталон-Юг»",
      clientName: "Захарова Екатерина",
      summary: "Клиент дал оценку NPS 9/10. Положительный отклик, оператор зафиксировал комментарий: «работой довольны, ничего менять не нужно».",
      category: "Целевое действие",
      subcategory: "NPS-оценка 9/10",
      scriptMatch: 95.00,
    }
  },
  { id: "oc-106", serviceId: "outbound-q2", uid: "1780573337.221452246", date: "04.06.2026", time: "14:42:11", operator: { id: "O0922", name: "Залевская Мария" }, contactNumber: "+7 (812) 446-22-15", segment: "Холодная база",      attempt: 3, status: "not_reached", durationSec: 5,
    ai: {
      companyName: "АО «РегионТорг»",
      summary: "Сработал автоответчик. Сообщение не оставляли — приоритет повторного дозвона.",
      category: "Без диалога",
      subcategory: "3-я попытка — финальный недозвон",
      scriptMatch: 0.00,
    }
  },
  { id: "oc-107", serviceId: "outbound-q2", uid: "1780576262.221465987", date: "04.06.2026", time: "15:30:55", operator: { id: "O1034", name: "Белов Денис" },     contactNumber: "+7 (985) 622-33-88", segment: "Возвраты к покупке", attempt: 1, status: "target",      durationSec: 198, topic: "Заказ оформлен",
    ai: {
      companyName: "ООО «Дом и Сад»",
      clientName: "Лебедева Анна",
      summary: "Клиент оформил заказ по итогам разговора. Контактные данные подтверждены, оператор передал заказ в обработку.",
      category: "Целевое действие",
      subcategory: "Оформление заказа",
  ...
  { id: "oc-108", serviceId: "outbound-q2", uid: "1780582102.221479628", date: "04.06.2026", time: "17:08:14", operator: { id: "O0608", name: "Петров Борис" },     contactNumber: "+7 (495) 521-78-90", segment: "Тёплая база",        attempt: 2, status: "reached",     durationSec: 115, topic: "Возражение «уже с конкурентом»", outcomeReason: "competitor",
    ai: {
      ...
      category: "Дозвон без целевого",
      subcategory: "Работают с конкурентом",
      scriptMatch: 79.00,
    }
  },

  // ── ВЧЕРА (03.06.2026) — 6 звонков ──
  { id: "oc-110", serviceId: "outbound-q2", uid: "1780469128.221507010", date: "03.06.2026", time: "09:45:18", operator: { id: "O0729", name: "Сидорова Наталья" }, contactNumber: "+7 (921) 555-12-90", segment: "Тёплая база",        attempt: 1, status: "target",      durationSec: 178, topic: "Согласие",
    ai: {
  ...
  { id: "oc-113", serviceId: "outbound-q2", uid: "1780490588.221548133", date: "03.06.2026", time: "15:42:55", operator: { id: "O0922", name: "Залевская Мария" }, contactNumber: "+7 (909) 100-88-77", segment: "Холодная база",      attempt: 1, status: "not_reached", durationSec: 6,
    ai: {
      companyName: "АО «РегионТорг»",
      summary: "Номер занят. Звонок переведён в очередь повторных попыток.",
      category: "Без диалога",
      subcategory: "Нет ответа",
      scriptMatch: 0.00,
    }
  },
  { id: "oc-114", serviceId: "outbound-q2", uid: "1780492736.221561874", date: "03.06.2026", time: "16:18:42", operator: { id: "O1207", name: "Кузнецов Евгений" }, contactNumber: "+7 (812) 220-44-66", segment: "NPS-опрос",          attempt: 2, status: "target",      durationSec: 122, topic: "Оценка 8/10",
    ai: {
      companyName: "Сеть «Золотой Берег»",
      clientName: "Михайлов Илья",
      summary: "Клиент дал оценку NPS 8/10. Положительный отклик, оператор зафиксировал комментарий: «в целом нормально, есть пара замечаний по доставке».",
      category: "Целевое действие",
      subcategory: "NPS-оценка 8/10",
      scriptMatch: 92.00,
    }
  },
  { id: "oc-115", serviceId: "outbound-q2", uid: "1780497035.221575515", date: "03.06.2026", time: "17:30:20", operator: { id: "O1034", name: "Белов Денис" },     contactNumber: "+7 (903) 412-66-21", segment: "Тёплая база",        attempt: 1, status: "reached",     durationSec: 134, topic: "Думает", outcomeReason: "thinking",
    ai: {
      ...
      clientName: "Васильева Ольга Николаевна",
      summary: "Клиент попросил время на обдумывание. Оператор зафиксировал согласие на повторный контакт через 5 рабочих дней, отправил материалы на почту.",
      category: "Дозвон без целевого",
      subcategory: "Берёт время на обдумывание",
      scriptMatch: 81.00,
    }
  },

  // ── ЭТА НЕДЕЛЯ (28–31.05.2026) — 5 звонков ──
  { id: "oc-120", serviceId: "outbound-q2", uid: "1780211743.221644020", date: "31.05.2026", time: "10:15:23", operator: { id: "O0451", name: "Иванова Анна" },     contactNumber: "+7 (903) 718-22-44", segment: "Тёплая база",        attempt: 1, status: "target",      durationSec: 192, topic: "Согласие",
    ai: {
      companyName: "ООО «Эталон-Юг»",
      summary: "Клиент согласился на встречу с менеджером для презентации продукта. Время согласовано, приглашение в календарь отправлено сразу после звонка.",
      category: "Целевое действие",
  ...
  { id: "oc-121", serviceId: "outbound-q2", uid: "1780130549.221657761", date: "30.05.2026", time: "11:42:08", operator: { id: "O0729", name: "Сидорова Наталья" }, contactNumber: "+7 (964) 332-11-90", segment: "Холодная база",      attempt: 3, status: "not_reached", durationSec: 9,
    ai: {
      companyName: "ООО «Эверест»",
      summary: "Сработал автоответчик. Сообщение не оставляли — приоритет повторного дозвона.",
      category: "Без диалога",
      subcategory: "3-я попытка — финальный недозвон",
      scriptMatch: 0.00,
  ...
  { id: "oc-122", serviceId: "outbound-q2", uid: "1780054234.221671402", date: "29.05.2026", time: "14:30:12", operator: { id: "O0834", name: "Соколов Виктор" },   contactNumber: "+7 (495) 880-22-11", segment: "Возвраты к покупке", attempt: 1, status: "target",      durationSec: 215, topic: "Заказ",
    ai: {
      companyName: "ООО «Дом и Сад»",
      clientName: "Соколов Артём",
      summary: "Клиент оформил заказ по итогам разговора. Контактные данные подтверждены, оператор передал заказ в обработку.",
  ...
  { id: "oc-123", serviceId: "outbound-q2", uid: "1780060316.221685143", date: "29.05.2026", time: "16:11:33", operator: { id: "O0608", name: "Петров Борис" },     contactNumber: "+7 (916) 545-66-77", segment: "NPS-опрос",          attempt: 1, status: "target",      durationSec: 105, topic: "Оценка 10/10",
    ai: {
      companyName: "ООО «АРТ-Декор»",
      clientName: "Кузнецова Мария Ивановна",
      summary: "Клиент дал оценку NPS 10/10. Положительный отклик, оператор зафиксировал комментарий: «работой довольны, ничего менять не нужно».",
      category: "Целевое действие",
      subcategory: "NPS-оценка 10/10",
      scriptMatch: 95.00,
    }
  },
  ...
  { id: "oc-130", serviceId: "outbound-q2", uid: "1779434330.221781030", date: "22.05.2026", time: "10:18:20", operator: { id: "O0451", name: "Иванова Анна" },     contactNumber: "+7 (905) 100-44-22", segment: "Тёплая база",        attempt: 1, status: "target",      durationSec: 158, topic: "Согласие",
    ai: {
      companyName: "ИП Голубев",
      clientName: "Морозов Виктор",
      summary: "Клиент согласился на встречу с менеджером для презентации продукта. Время согласовано, приглашение в календарь отправлено сразу после звонка.",
      category: "Целевое действие",
      subcategory: "Согласие на встречу",
      scriptMatch: 92.00,
  ...
  { id: "oc-133", serviceId: "outbound-q2", uid: "1778246788.221822153", date: "08.05.2026", time: "16:25:55", operator: { id: "O1207", name: "Кузнецов Евгений" }, contactNumber: "+7 (903) 233-44-55", segment: "Холодная база",      attempt: 1, status: "not_reached", durationSec: 7,
    ai: {
      companyName: "ООО «Северный Альянс»",
      summary: "Сработал автоответчик. Сообщение не оставляли — приоритет повторного дозвона.",
      category: "Без диалога",
      subcategory: "Нет ответа",
      scriptMatch: 0.00,
...
export const serviceReports: Record<string, ServiceReport> = {
    ...
    yearlyReports: {
      "2026": {
        rows: [
          ...
          { metric: "Повторные обращения", values: ["812", "760", "775", "810", "792", "545", null, null, null, null, null, null] },
          { metric: "Перезвоны по заявке", values: ["198", "182", "190", "176", "232", "150", null, null, null, null, null, null] },
        ],
      ...
      "2025": {
        rows: [
          ...
          { metric: "Повторные обращения", values: ["684", "641", "713", "648", "677", "650", "610", "630", "729", "821", "1 163", "1 142"] },
          { metric: "Перезвоны по заявке", values: ["176", "165", "182", "170", "185", "170", "162", "168", "188", "205", "268", "255"] },
        ],
      ...
      "2024": {
        rows: [
          ...
          { metric: "Повторные обращения", values: ["469", "445", "483", "462", "515", "494", "473", "483", "539", "613", "896", "872"] },
          { metric: "Перезвоны по заявке", values: ["130", "122", "134", "128", "142", "136", "128", "134", "150", "170", "220", "210"] },
        ],
    ...
    yearlyReports: {
      "2026": {
        rows: [
          ...
          { metric: "Переведённые",  values: ["60", "58", "66", "78", "64", "44", null, null, null, null, null, null] },
          { metric: "Повторные обращения", values: ["372", "354", "378", "395", "402", "270", null, null, null, null, null, null] },
          { metric: "Перезвоны по заявке", values: ["84", "80", "86", "85", "92", "62", null, null, null, null, null, null] },
        ],
      ...
      "2025": {
        rows: [
          ...
          { metric: "Переведённые",  values: ["53", "50", "56", "52", "57", "55", "52", "54", "59", "65", "72", "69"] },
          { metric: "Повторные обращения", values: ["307", "290", "322", "302", "328", "319", "302", "310", "342", "374", "415", "400"] },
          { metric: "Перезвоны по заявке", values: ["72", "68", "75", "70", "76", "74", "70", "72", "80", "88", "98", "95"] },
        ],
      ...
      "2024": {
        rows: [
          ...
          { metric: "Переведённые",  values: ["42", "41", "44", "42", "45", "44", "42", "44", "47", "52", "57", "55"] },
          { metric: "Повторные обращения", values: ["244", "235", "252", "241", "258", "252", "244", "252", "270", "299", "331", "319"] },
          { metric: "Перезвоны по заявке", values: ["58", "55", "60", "57", "61", "59", "57", "59", "64", "71", "80", "76"] },
        ],
  ...
  "chatbot": {
    ...
    yearlyReports: {
      ...
      "2025": {
        rows: [
          ...
          // Голосовые диалоги: на старте обкатка канала «Телефон», рост к концу года
          { metric: "Длительность разговоров, мин", values: ["115", "108", "120", "112", "118", "112", "108", "110", "122", "138", "175", "170"] },
        ],
    ...
    monthOverMonth: [
      ...
      { metric: "Длительность разговоров, мин", current: "168", prev: "162", delta: "+4%", tone: "up" },
    ],
    monthOverMonthMtd: [
      ...
      { metric: "Длительность разговоров, мин", current: "23",  prev: "21",  delta: "+10%", tone: "up" },
    ],
    heatmap: {
      days: DAYS_7,
      hours: HOURS_24,
