...
import { Bell, ChevronRight, Coins, AlertTriangle } from "lucide-react";
...
export function Topbar() {
  ...
  return (
    <header className="sticky top-0 z-30 flex h-16 items-center justify-between gap-4 border-b border-navy/[0.06] bg-canvas/80 px-8 backdrop-blur">
      <nav className="flex items-center gap-1.5 text-sm text-navy/55">
