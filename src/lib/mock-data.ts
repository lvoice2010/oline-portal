...
export type ScriptSection = {
  ...
  title: string;
  description?: string;
  required?: boolean; // обязательный этап (приветствие, прощание)
  durationHint?: string; // «~10 сек», «1–2 мин»
  steps: ScriptStep[];
};
...
export type ServiceScript = {
  serviceName: string;
  version: string; // «3.2»
  updatedAt: string; // «18.05.2026»
  approvedBy: string; // «Иванова М. (руководитель сервиса)»
  context: string; // короткое описание услуги, для какого типа звонков
...
export const serviceScripts: Record<string, ServiceScript> = {
  "hotline-247": {
    ...
    context:
      "Скрипт входящей линии eCommerce. Покрывает основные сценарии: статус заказа, возврат, доставка, технические вопросы, оплата. Время среднего диалога — 2 мин 14 сек.",
    sections: [
      {
        id: "greeting",
        title: "1. Приветствие",
        required: true,
        durationHint: "~10 сек",
        description: "Корректное приветствие с представлением бренда и оператора.",
        steps: [
          {
            kind: "operator",
            text: "Добрый день! Магазин Панго Карс, [имя оператора], слушаю вас.",
            alternatives: [
              "Здравствуйте! Панго Карс, [имя оператора] на связи.",
              "Добрый вечер! Панго Карс, меня зовут [имя], чем могу помочь?",
            ],
          },
          {
            kind: "note",
            tone: "info",
            text: "Голос — тёплый, не торопиться. После «слушаю вас» — пауза 1–2 сек, дать клиенту начать.",
          },
        ],
      },
      {
        id: "identification",
        title: "2. Идентификация запроса",
        required: true,
        durationHint: "~15 сек",
        description: "Уточняем, кто звонит и в чём суть обращения. Не запрашиваем лишние данные.",
        steps: [
          {
            kind: "client",
            text: "Здравствуйте, я по поводу заказа…",
          },
          {
            kind: "operator",
            text: "Конечно! Подскажите, пожалуйста, ваше имя и номер заказа.",
          },
          {
            kind: "client",
            text: "Мария, заказ № 4452.",
          },
          {
            kind: "operator",
            text: "Спасибо, Мария. Чем могу помочь?",
          },
          {
            kind: "note",
            tone: "warn",
            text: "Если клиент не помнит номер заказа — спросить телефон, на который оформлен заказ. Не запрашиваем паспортные данные!",
          },
        ],
      },
      {
        id: "status",
        title: "3. Топик «Статус заказа»",
        durationHint: "1–1,5 мин",
        description: "Самая частая тема. Цель — быстро дать клиенту понятную информацию о доставке.",
        steps: [
          {
            kind: "operator",
            text: "Сейчас посмотрю. Ваш заказ № [номер] передан в курьерскую службу, доставка завтра до 12:00. Курьер позвонит за 30 минут до приезда.",
          },
          {
            kind: "note",
            tone: "warn",
            text: "Если задержка > 3 дней — извиниться, предложить компенсацию (скидка 5% на следующий заказ).",
          },
          {
            kind: "note",
            tone: "info",
            text: "Если клиент хочет изменить адрес — оформить заявку через CRM, передать в логистику.",
          },
          {
            kind: "client",
      ...
      {
        id: "return",
        title: "4. Топик «Возврат»",
        durationHint: "2–3 мин",
        description: "Оформление возврата по 14-дневному правилу.",
        steps: [
          {
            kind: "operator",
            text: "Уточните, пожалуйста, причину возврата — не подошёл размер, брак, или другая причина?",
          },
          {
            kind: "client",
          ...
          {
            kind: "operator",
            text: "Понимаю. Оформляю заявку на возврат. Деньги поступят на карту в течение 5 рабочих дней. Инструкция по отправке товара придёт на почту.",
          },
          {
            kind: "note",
            tone: "ok",
            text: "Размер / цвет / просто передумал — оформляем без вопросов в течение 14 дней с момента получения.",
          },
          {
            kind: "note",
            tone: "warn",
            text: "Брак / повреждение — переключить на техподдержку 2-й линии (вн. 242).",
          },
        ],
      },
      {
        id: "delivery",
        title: "5. Топик «Условия доставки»",
        durationHint: "30–60 сек",
        steps: [
          {
            kind: "client",
            text: "Какие у вас условия доставки в регионы?",
          },
          {
            kind: "operator",
            text: "У нас есть несколько вариантов: курьер по Москве — на следующий день, по МО — 2–3 дня, регионы — 3–7 дней. Стоимость зависит от веса и зоны, рассчитывается на сайте при оформлении.",
          },
          {
            kind: "note",
            tone: "info",
            text: "Бесплатная доставка при заказе от 5 000 ₽ по Москве и МО.",
          },
        ],
      },
      {
        ...
        required: true,
        durationHint: "~5 сек",
        description: "Корректное завершение разговора. Не забыть про оценку диалога.",
        steps: [
          {
            kind: "operator",
            text: "Спасибо за обращение в Панго Карс! Хорошего дня. Если будут вопросы — мы на связи 24/7.",
            alternatives: [
              "Рад был помочь! Хорошего дня и удачных покупок.",
          ...
          },
          {
            kind: "note",
            tone: "info",
            text: "Перед завершением попросить оценить диалог: «Если не сложно, после звонка оцените мою работу — это поможет нам стать лучше».",
          },
        ],
      },
    ],
  ...
  "hotline-fte": {
    ...
    approvedBy: "Носенко С. (руководитель направления B2B Адамас)",
    context:
      "Скрипт для входящей линии B2B-клиентов Адамаса. Корпоративные счета, изменение условий договоров, техническая поддержка крупных партнёров. Среднее время диалога — 3 мин 02 сек.",
    sections: [
      {
        id: "greeting",
        title: "1. Приветствие",
        ...
        steps: [
          {
            kind: "operator",
            text: "Адамас, B2B-поддержка, [имя оператора], слушаю вас.",
            alternatives: [
              "Здравствуйте! Адамас, отдел корпоративных клиентов, [имя] на связи.",
            ],
          },
          {
            kind: "note",
            tone: "info",
            text: "B2B-аудитория — формальный тон, не сокращать «здрасьте», обращаться на «вы».",
          },
        ],
      },
      {
        id: "identification",
        title: "2. Идентификация компании и контакта",
        required: true,
        durationHint: "~20 сек",
        steps: [
          {
            kind: "operator",
            text: "Подскажите, пожалуйста, название вашей компании и ваше имя.",
          },
          {
            kind: "client",
            text: "ООО «Меркурий», Анна Петрова.",
          },
          {
            kind: "operator",
            text: "Анна, спасибо. Вижу ваш корпоративный счёт. Чем могу помочь?",
          },
          {
            kind: "note",
            tone: "warn",
            text: "Сверка в CRM обязательна — на корпоративные счета могут звонить разные сотрудники. Если контактное лицо не в списке — уточнить роль.",
          },
        ],
      },
      {
        id: "corporate-account",
        title: "3. Топик «Корпоративный счёт»",
        durationHint: "2–3 мин",
        description: "Основная тематика. Запросы по балансу, выставлению счёта, акту сверки.",
        steps: [
          {
            kind: "client",
            text: "Нужен акт сверки за прошлый квартал.",
          },
          {
            kind: "operator",
            text: "Конечно. Подготовлю акт сверки за Q1 2026, отправлю на ваш email до конца рабочего дня. Подтвердите, пожалуйста, адрес: anna.petrova@mercury.ru — верно?",
          },
          {
            kind: "note",
            tone: "ok",
            text: "Все акты и счета отправляются через ЭДО + дублируются на email контактного лица. Срок — не позднее следующего рабочего дня.",
          },
        ],
      },
      {
        id: "contract-change",
        title: "4. Топик «Изменение условий договора»",
        durationHint: "3–5 мин",
        description: "Внимание: критичная тематика, требует точности в формулировках.",
        steps: [
          {
            kind: "client",
            text: "Хотим увеличить пакет услуг.",
          },
          {
            kind: "operator",
            text: "Понимаю. Это потребует подписания допсоглашения к договору. Я подготовлю расчёт и передам вашему менеджеру — он свяжется с вами в течение рабочего дня для согласования деталей.",
          },
          {
            kind: "note",
            tone: "warn",
            text: "Не называть цены без согласования с менеджером. Не обещать конкретных условий — только «менеджер свяжется».",
          },
          {
            kind: "note",
            tone: "info",
            text: "Зафиксировать в CRM тип запроса (расширение / сокращение / смена тарифа) и приоритет.",
          },
        ],
      },
      {
        id: "tech-support",
        title: "5. Топик «Технический вопрос»",
        durationHint: "5–10 мин",
        description: "Сложные кейсы передаются на 2-ю линию.",
        steps: [
          {
            kind: "client",
            text: "У нас не работает интеграция с вашим API.",
          },
          {
            kind: "operator",
            text: "Сейчас передам обращение в техническую поддержку. Специалист свяжется с вами в течение часа. Уточните, пожалуйста, ID интеграции и время начала проблемы.",
          },
          {
            kind: "note",
            tone: "warn",
            text: "1-я линия не разбирает API/интеграции — сразу эскалация на L2 (вн. 248) с фиксацией контекста.",
          },
        ],
      },
      {
        ...
        steps: [
          {
            kind: "operator",
            text: "Анна, спасибо за обращение. Все договорённости зафиксированы. Если будут вопросы — линия доступна Пн–Пт с 9:00 до 18:00.",
          },
          {
            kind: "note",
            tone: "info",
            text: "Обязательно повторить ключевые договорённости перед прощанием — сроки, ответственных, дату следующего контакта.",
          },
        ],
      },
    ],
  ...
  "outbound-q2": {
    serviceName: "Исходящая кампания Q2 2026 · Панго Карс",
    version: "1.4",
    updatedAt: "02.04.2026",
    approvedBy: "Маркетинг Панго Карс + руководитель проекта O'LINE",
    context:
      "Скрипт холодных и тёплых звонков по базе Панго Карс. Цель — продажа допуслуги / возврат к покупке / NPS-опрос. Норматив — 3 попытки дозвона, ~2:45 на разговор.",
    sections: [
      {
        id: "opening",
        title: "1. Установление контакта",
        required: true,
        durationHint: "~15 сек",
        description: "Цель — корректно представиться и быстро объяснить причину звонка, не вызывая раздражения.",
        steps: [
          {
            kind: "operator",
            text: "Добрый день! Меня зовут [имя], я звоню из магазина Панго Карс по вопросу [причина — выбираем по сегменту]. У вас есть пара минут?",
            alternatives: [
              "Здравствуйте! Это [имя] из Панго Карс. Звоню по специальному предложению для постоянных клиентов. Удобно сейчас говорить?",
            ],
          },
          {
            kind: "note",
            tone: "warn",
            text: "Если клиент сразу говорит «нет, занят» — не давить, предложить перезвонить в удобное время.",
          },
        ],
      },
      {
        ...
        durationHint: "~30 сек",
        description: "Несколько коротких вопросов, чтобы понять, что предложить.",
        steps: [
          {
            kind: "operator",
            text: "Вы часто заказывали у нас в прошлом году — хочу спросить, как давно были на сайте? Видели наши новые поступления?",
          },
          {
            kind: "client",
            text: "Давно не заходил, последний раз весной.",
          },
          {
            kind: "operator",
            text: "Понял. У нас как раз сейчас обновили линейку — есть много нового по вашим интересам. Можно рассказать про 2-3 ключевые позиции?",
          },
        ],
      },
      {
        ...
        title: "3. Презентация",
        durationHint: "30–60 сек",
        description: "Не больше 2-3 преимуществ. Конкретно, цифры, без воды.",
        steps: [
          {
            kind: "operator",
            text: "У нас сейчас три выгодных решения для вас: [конкретное предложение по сегменту]. Это даёт [конкретная выгода в ₽ или времени].",
          },
          {
            kind: "note",
            tone: "info",
            text: "Назвать максимум 3 преимущества. Каждое подкреплять цифрами или примером. Не говорить «качество» / «надёжность» — это вода.",
          },
        ],
      },
      {
        id: "objections",
        title: "4. Отработка возражений",
        durationHint: "1–3 мин",
        description: "Самый сложный этап. Используем готовые блоки по типам возражений.",
        steps: [
          {
            kind: "client",
            text: "У меня уже есть проверенный поставщик.",
          },
          {
            kind: "operator",
            text: "Здорово, что у вас всё стабильно. Я не предлагаю менять поставщика — мы можем быть вторым опционом на случай, если у основного будут перебои. Многие наши клиенты так и работают.",
          },
          {
            kind: "client",
            text: "Дорого.",
          ...
          {
            kind: "operator",
            text: "Понимаю, цена важна. Скажу так: при текущей доле горячих контактов наши клиенты возвращают вложения за 2–3 месяца. Я могу прислать кейсы — будете готовы посмотреть?",
          },
          {
            kind: "client",
            text: "Не сейчас, перезвоните позже.",
          },
          {
            kind: "operator",
            text: "Конечно. Когда вам удобнее — на следующей неделе? Я пришлю на email краткую справку, чтобы вы могли посмотреть до звонка.",
          },
          {
            kind: "note",
            tone: "warn",
            text: "Не более 2 кругов отработки одного возражения. Если 2-й раз слышим «нет» — мягко завершаем со словами «понимаю, если изменится — буду рад вернуться».",
          },
        ],
      },
      {
        id: "closing",
        title: "5. Закрытие со следующим шагом",
        required: true,
        durationHint: "~20 сек",
        description: "Главное — не оставить контакт без конкретного следующего шага.",
        steps: [
          {
            kind: "operator",
            text: "Договорились: я пришлю на ваш email [материал], а на следующей неделе во вторник, например в 11:00, перезвоню — обсудим вашу реакцию. Какой email лучше использовать?",
          },
          {
            kind: "client",
            text: "[email клиента]",
          ...
          {
            kind: "operator",
            text: "Записал. Спасибо за разговор, до связи во вторник!",
          },
          {
            kind: "note",
            tone: "ok",
            text: "Обязательно зафиксировать в CRM: дату следующего контакта, обещанные материалы, поднятые возражения. Без этого следующий звонок будет с нуля.",
          },
        ],
      },
    ],
